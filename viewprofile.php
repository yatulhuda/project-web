        ...
        <div class="box form-box">
            ...
            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                <div class="profile-info">
                    <p>Name: <?php echo $row['AdminName']; ?></p>
                    <p>Admin ID: <?php echo $row['ID']; ?></p>
                    <p>Email: <?php echo $row['AdminEmail']; ?></p>
                    <p>Phone Number: <?php echo $row['AdminHPnum']; ?></p>
                </div>
            <?php endwhile; ?>
            <a href="editprofile.php" class="btn edit-btn">Edit</a> <!-- Edit button -->
            <a href="admin.php" class="btn back-btn">Back</a> <!-- Back button -->
        </div>
    </div>
</div>
</body>
